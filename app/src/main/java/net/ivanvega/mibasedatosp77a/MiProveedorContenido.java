    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (uriMatcher.match(uri)){
            case 2:
                ...
                //String idcontacto[] = {uri.getLastPathSegment()};

                id = _sqliteDB.delete(MiDB.TABLE_NAME_CONTACTOS, MiDB.COLUMNS_NAME_CONTACTO[0] + " = ?", new String[]{uri.getLastPathSegment()});
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (uriMatcher.match(uri)){
            case 2:
                ...
                id = _sqliteDB.update(MiDB.TABLE_NAME_CONTACTOS, contentValues, MiDB.COLUMNS_NAME_CONTACTO[0] + " = ?", new String[]{uri.getLastPathSegment()});
